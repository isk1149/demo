...
@NoArgsConstructor
@AllArgsConstructor
public class HsptlBassInfoInqire {
    //private InnerHsptlBassInfoInqireResponse response;
    private HsptlBassInfoInqireResponse response;
    ...
    @NoArgsConstructor
    //@AllArgsConstructor
    static class InnerHsptlBassInfoInqireResponse {
        private InnerHsptlBassInfoInqireHeader header;
        private InnerHsptlBassInfoInqireBody body;
        ...
        @NoArgsConstructor
        //@AllArgsConstructor
        static class InnerHsptlBassInfoInqireHeader {
        ...
        @NoArgsConstructor
        //@AllArgsConstructor
        static class InnerHsptlBassInfoInqireBody {
            private InnerHsptlBassInfoInqireItems items;
            ...
            @NoArgsConstructor
            //@AllArgsConstructor
            static class InnerHsptlBassInfoInqireItems {
                private List<InnerHsptlBassInfoInqireItem> item = new ArrayList<>();
                ...
                static class InnerHsptlBassInfoInqireItem {
                    private String hpid;
...
/*    public List<InnerHsptlBassInfoInqireItem> getItems() {
        //List<InnerHsptlBassInfoInqireItem> lists = this.getResponse().getBody().getItems().getItem();
